...
# This election mechanism consists of al clients tryingto put their name
...
def leader_election(client, server_name):
    ...
    # Create a lease before creating a key. This way, if the client ever
    ...
    # expire.
    # reference: https://help.compose.com/docs/etcd-using-etcd3-features#section-leases
    lease = client.lease(5) #### TODO: ERROR OCCURS HERE
